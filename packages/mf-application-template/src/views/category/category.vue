  ...
  <div class="page_search">
    <div class="page_search_form">
      ...
      >
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('category_management.background_category_management.code')" prop="code">
              <el-input v-model="form.code" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item :label="$t('category_management.background_category_management.name')" prop="name">
              <el-input v-model="form.name" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item :label="$t('category_management.background_category_management.state')" prop="status">
    ...
    <div class="page_table">
      ...
      >
        <el-table-column
          :label="$t('category_management.background_category_management.code')"
          sortable="custom"
        ...
        <el-table-column
          :label="$t('category_management.background_category_management.name')"
          sortable="custom"
          show-overflow-tooltip
          prop="name"
          min-width="200px"
        ...
        <el-table-column
         :label="$t('category_management.background_category_management.state')"
          sortable="custom"
          show-overflow-tooltip
          prop="status"
          min-width="100px"
        ...
        <el-table-column
          :label="$t('category_management.background_category_management.remark')"
          sortable="custom"
          show-overflow-tooltip
          prop="memo"
          min-width="150px"
          ...
          <template slot-scope="scope">
            ...
            >
              ...
              <div style="text-align: right; margin: 0">
                ...
                <el-button type="primary" size="mini" @click="onDelBtnClick(scope.row, $event)">{{$t('button.cancel')}}</el-button>
              </div>
...
export default {
  data () {
    return {
      ...
      key: 'code',
      detailTitle: '后台类目',
      detailPage: '/master-data/goods/category-detail',
      searchURL: 'QueryCategory',
      countURL: 'CountCategory',
      removeURL: 'RemoveCategory',
      sort: {
