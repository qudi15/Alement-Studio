  ...
  <div class="page_search">
    <div class="page_search_form">
      ...
      >
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('product_management.brand_management.code')" prop="code">
              <el-input v-model="form.code" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item :label="$t('product_management.brand_management.name')" prop="name">
              <el-input v-model="form.name" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item :label="$t('product_management.brand_management.type')" prop="typeValuesetValueCode">
          ...
          <el-col :span="8">
            <el-form-item :label="$t('product_management.brand_management.state')" prop="status">
          ...
          <el-col :span="8">
            <el-form-item label="创建开始日期" prop="createTimeStart">
              <el-date-picker v-model="form.createTimeStart" type="date"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item label="创建结束日期" prop="createTimeEnd">
              <el-date-picker v-model="form.createTimeEnd" type="date"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <div class="page_table">
      ...
      >
        <el-table-column
          :label="$t('product_management.brand_management.code')"
          sortable="custom"
        ...
        <el-table-column
          :label="$t('product_management.brand_management.name')"
          sortable="custom"
          show-overflow-tooltip
          prop="name"
          min-width="200px"
        ...
        <el-table-column
          :label="$t('product_management.brand_management.type')"
          sortable="custom"
          show-overflow-tooltip
        ...
        <el-table-column
          :label="$t('product_management.brand_management.state')"
          sortable="custom"
          show-overflow-tooltip
          prop="status"
          min-width="100px"
        ...
        <el-table-column
          :label="$t('product_management.brand_management.remark')"
          sortable="custom"
          show-overflow-tooltip
          prop="memo"
          min-width="300px"
...
export default {
  data () {
    return {
      ...
      key: 'code',
      detailTitle: '品牌',
      detailPage: '/master-data/goods/brand-detail',
      searchURL: 'QueryBrand',
      countURL: 'CountBrand',
      removeURL: 'RemoveBrand',
      sort: {
